  ...
  <div class="container">
    <div class="flex-w flex-sb-m p-b-52">
      <div class="flex-w flex-l-m filter-tope-group m-tb-10">
        ...
        <button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".danh_mục">
          Danh mục 1
        </button>
      </div>
      ...
      <div class="dis-none panel-filter w-full p-t-10">
        <div class="wrap-filter flex-w bg6 w-full p-lr-40 p-t-27 p-lr-15-sm">
          ...
          <div class="filter-col3 p-r-15 p-b-27">
            ...
            <ul>
              <li class="p-b-6">
                <span class="fs-15 lh-12 m-r-6" style="color: #mã_màu;">
    ...
    <div class="row isotope-grid">
      <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item danh_muc_san_pham">
        <!-- Block2 -->
        <div class="block2">
          <div class="block2-pic hov-img0">
            <img src="đường dẫn ảnh" alt="IMG-PRODUCT">
                ...
                <div class="size-204 respon6-next">
                  <div class="rs1-select2 bor8 bg0">
                    <select class="js-select2" name="time">
                      <option>Chọn một sự lựa chọn</option>
                      <option>Tên màu</option>
                    </select>
